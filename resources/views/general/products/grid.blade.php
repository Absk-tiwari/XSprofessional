    ...
    <div class="col-lg-9">
        ...
        <div class="row products-list">
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card">
                    <?php $image = $product->imageGallery? json_decode($product->imageGallery[count($product->imageGallery)-1])->medium :
                    ...
                    <div class="card-body bg-light-subtle rounded-bottom">
                        ...
                        <h4 class="fw-semibold text-dark mt-2 d-flex align-items-center gap-1">
                            ...
                            ?>
                            ₹{{$price}} <small class="text-muted"> {{ $product->discount? "($product->discount% Off)":'' }}</small>
                        </h4>
                        <div class="mt-3">
                            <div class="d-flex gap-1">
                                <a href="{{ route('admin.products.edit', ['product'=> $product->id ])}}" id="{{ $product->id }}__" class="btn btn-outline-dark border border-secondary-subtle d-flex align-items-center justify-content-center gap-1 w-100"> Edit
                                </a>
