...
class OrderController extends Controller
{
    public function create(Request $request)
    {
        try {
            ...
            $order->orderData = $request->orderItems;
            $order->save();
    ...
    public function index(Request $request)
    {
        ...
        return view("general.orders.list", compact('orders'));
    }
    ...
    public function update(Request $request) {
        try {
            ...
            if($order->exists()){
                ...
                Notification::route("mail", $order->email)->notify(new OrderStatusChange($names->toArray(),$request->amount, $order->orderNumber, $order->name));
            }
